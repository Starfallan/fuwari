...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable: true,
		src: "https://img.170529.xyz/2025/07/custom1.avif", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
	...
	favicon: [
		...
		{
			src: "https://img.170529.xyz/2025/08/favicon.ico", // Path of the favicon, relative to the /public directory
...
export const commentConfig: CommentConfig = {
	giscus: {
		repo: "Starfallan/Giscus",
		repoId: "R_kgDOOj3Png",
		category: "Announcements",
		categoryId: "DIC_kwDOOj3Pns4Cpu2b",
		mapping: "pathname",
		strict: "0",
		reactionsEnabled: "1",
		emitMetadata: "0",
